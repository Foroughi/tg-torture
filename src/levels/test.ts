...
export class Test_Scene extends BaseGameScene {
    ...
    override createBlocks() {
        this.drawStaticBlock(0, this.MaxHeight - 10, this.MaxWidth, 1);
        this.createTrap1();
    }
    ...
    createTrap1() {
        ...
        const tile = this.getBlock(14, this.MaxHeight - 10) as Phaser.GameObjects.Sprite;
        ...
        this.setBlock(14, this.MaxHeight - 10, dyn);
